...
public class RemoteAPI {
    ...
    public static Proxies.Response getProxies() {
        HttpResponse<String> httpResponse = Unirest.get("https://panel.mcprot.com/api/" + Main.getConfig().getApiKey() + "/proxies").asString();
        Gson g = new Gson();
    ...
    public static Servers.Response getServers() {
        HttpResponse<String> httpResponse = Unirest.get("https://panel.mcprot.com/api/" + Main.getConfig().getApiKey() + "/servers").asString();
        Gson g = new Gson();
    ...
    public static void putConnection(List<Connection> connection) {
        ...
        HttpResponse<String> httpResponse = Unirest.put("https://panel.mcprot.com/api/" + Main.getConfig().getApiKey() + "/connection")
    ...
    public static void putAnalytic(List<Analytic> analytics) {
        ...
        HttpResponse<String> httpResponse = Unirest.put("https://panel.mcprot.com/api/" + Main.getConfig().getApiKey() + "/analytic")
                .header("Content-Type", "application/json")
